...
export class Section {
    ...
    createNewRound(event, history = false, forceIndex = null){ //event argument se nepouziva, eventuelne odstranit
        ...
        const legendTemplate = document.getElementById('roundSettingTemplate');
        const legendNode = legendTemplate.content.cloneNode(true).firstElementChild;
        legendNode.dataset.round = newRoundNumber;
    ...
    updateInsertButtons(){
        ...
        rounds.forEach((legendRound, index) => {
            ...
            // keep insert button visible for all rounds
        });
    }
